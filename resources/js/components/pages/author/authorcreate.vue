          ...
          <div class="tab-content">
            <div class="tab-pane active" id="basicdetails">
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="author" v-model="form.author_name">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="author" v-model="form.author_title">
                </div>
                <div class="form-group">
                  <label for="author">Social Profile</label>
                  <input type="text" class="form-control" id="author" v-model="form.social_profile">
                </div>
            ...
            <div style="float:right;">
              ...
              <v-btn
                href="#"
                flat
                class="btn btn-success btn-large white--text"
...
export default {
  ...
  methods: {
    ...
    updateauthor() {
      ...
      axios
        .post("/author/" + this.authorid, formdata, {
          headers: {
            "Content-Type": "multipart/form-data"
          }
        })
    ...
    getallauthor() {
      axios.get("/author/create").then(response => {
        this.author = response.data[0];
        this.subauthor = response.data[1];
      });
    },
    goBack() {
      window.history.back();
  ...
  created() {
    ...
    if (this.authorid !== "") {
      ...
      axios.get("/author/" + this.authorid).then(response => {
        this.form = response.data;
        this.imageUrl = "/files/author/" + response.data.image;
        // this.parentstatus = true;
        // this.childstatus = true;
      });
    }
