        ...
        <div class="card-header card-header-tabs card-header-primary">
          <div class="nav-tabs-navigation">
            <div class="nav-tabs-wrapper">
              <span class="nav-tabs-title">publisher:</span>
              ...
              <div class="card-body">
                <form>
                  <div class="form-group">
                    <label for="publisher">publishername</label>
                    <input type="text" class="form-control" id="publisher" v-model="form.pub_name">
                </div>
                  <div class="form-group">
                    <label for="publisher">Address</label>
                    <input type="text" class="form-control" id="publisher" v-model="form.address">
                </div>
                  <div class="form-group">
                    <label for="publisher">contact</label>
                    <input type="text" class="form-control" id="publisher" v-model="form.contact">
                </div>
                  ...
                  <a
                    ...
                    v-if="!publisheredit"
                  >Submit</a>
                  <a href="#" class="btn btn-primary" @click.prevent="updatepublisher" v-else>Update</a>
...
export default {
  ...
  methods: {
    ...
    updatepublisher() {
      ...
      axios
        .post("/publisher/" + this.publisherid, formdata, {
          headers: {
            "Content-Type": "multipart/form-data"
          }
        })
    ...
    getallpublisher() {
      axios.get("/publisher/create").then(response => {
        this.publisher = response.data[0];
        this.subpublisher = response.data[1];
      });
    },
        goBack() {
  ...
  created() {
    ...
    if (this.publisherid !== "") {
      ...
      axios.get("/publisher/" + this.publisherid).then(response => {
